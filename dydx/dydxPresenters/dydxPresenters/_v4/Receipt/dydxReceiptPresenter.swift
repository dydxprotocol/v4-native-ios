...
class dydxReceiptPresenter: HostedViewPresenter<dydxReceiptViewModel>, dydxReceiptPresenterProtocol {
    ...
    let liquidationPriceViewModel = dydxReceiptItemViewModel()
    let positionMarginViewModel = dydxReceiptItemViewModel()
    let positionLeverageViewModel = dydxReceiptItemViewModel()
