...
public class WalletConnectionViewModel: PlatformViewModel {
    ...
    @Published public var walletImage: WalletImage?
    ...
    public static var previewValue: WalletConnectionViewModel = {
        ...
        vm.walletImage = .url(URL(string: "https://s3.amazonaws.com/dydx.exchange/logos/walletconnect/lg/9d373b43ad4d2cf190fb1a774ec964a1addf406d6fd24af94ab7596e58c291b2.jpeg"))
        vm.equity = "$1234.50"
    ...
    public override func createView(parentStyle: ThemeStyle = ThemeStyle.defaultStyle, styleKey: String? = nil) -> PlatformView {
        PlatformView(viewModel: self, parentStyle: parentStyle, styleKey: styleKey) { [weak self] style  in
            ...
            switch self?.walletImage {
            case .url(let uRL):
                icon = PlatformIconViewModel(type: .url(url: uRL), clip: .defaultCircle)
            case .asset(let string):
                icon = PlatformIconViewModel(type: .asset(name: string, bundle: Bundle.dydxView))
            case nil:
                icon = nil
            }
