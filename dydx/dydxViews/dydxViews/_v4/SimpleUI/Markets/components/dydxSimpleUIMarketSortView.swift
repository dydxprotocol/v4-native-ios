...
public class dydxSimpleUIMarketSortViewModel: PlatformViewModel {
    ...
    @Published public var items: [dydxSimpleUIMarketSortViewModel.MenuItem] = []
    ...
    private func createItemView(item: dydxSimpleUIMarketSortViewModel.MenuItem, parentStyle: ThemeStyle) -> some View {
        HStack {
            Text(item.title)
