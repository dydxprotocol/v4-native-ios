//
//  ParticlesCandleChartDataSet.swift
//  PlatformParticles
//
...
@objc public class ParticlesCandleChartDataSet: CandleChartDataSet, ParticlesChartDataSetProtocol {
    ...
    public func entry() -> ParticlesChartDataEntryProtocol {
        return ParticlesCandleChartDataEntry()
    }

    public func notify() {
        presenter.object?.displayGraphing(animated: false)
    }
}
